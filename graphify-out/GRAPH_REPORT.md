...
- [[_COMMUNITY_Academy Navigation|Academy Navigation]]
- [[_COMMUNITY_Agent Instructions|Agent Instructions]]
- [[_COMMUNITY_Public Asset Hygiene|Public Asset Hygiene]]
- [[_COMMUNITY_SEO Proof Publication System|SEO Proof Publication System]]
- [[_COMMUNITY_Technical SEO Baseline|Technical SEO Baseline]]
- [[_COMMUNITY_Desktop Support|Desktop Support]]
- [[_COMMUNITY_SEO Proof Execution Pipeline|SEO Proof Execution Pipeline]]
- [[_COMMUNITY_Decision Pages|Decision Pages]]
- [[_COMMUNITY_Product Glossary|Product Glossary]]
- [[_COMMUNITY_POSPal Post-Redesign SEO Evaluation|POSPal Post-Redesign SEO Evaluation]]
- [[_COMMUNITY_Agent Instructions|Agent Instructions]]
- [[_COMMUNITY_POSPal Information Architecture And Onboarding|POSPal Information Architecture And Onboarding]]
- [[_COMMUNITY_POSPal AI-Discovery Prompt Bank|POSPal AI-Discovery Prompt Bank]]
- [[_COMMUNITY_Το POSPal, με καθαρά λόγια.|Το POSPal, με καθαρά λόγια.]]
- [[_COMMUNITY_POSPal Customer Guides Plan|POSPal Customer Guides Plan]]
- [[_COMMUNITY_Page-by-page audit|Page-by-page audit]]
- [[_COMMUNITY_POSPal Homepage Concept Directions|POSPal Homepage Concept Directions]]
- [[_COMMUNITY_POSPal SEO Opportunities|POSPal SEO Opportunities]]
- [[_COMMUNITY_AI Discovery Measurement Baseline|AI Discovery Measurement Baseline]]
- [[_COMMUNITY_POSPal Technical SEO Baseline|POSPal Technical SEO Baseline]]
- [[_COMMUNITY_Work Completed|Work Completed]]
- [[_COMMUNITY_Execution order|Execution order]]
- [[_COMMUNITY_POSPal AI-Discovery Scorecard|POSPal AI-Discovery Scorecard]]
- [[_COMMUNITY_POSPal Entity Foundation|POSPal Entity Foundation]]
- [[_COMMUNITY_Academy Technical SEO Migration|Academy Technical SEO Migration]]
- [[_COMMUNITY_POSPal Homepage Design Brief|POSPal Homepage Design Brief]]
- [[_COMMUNITY_Product Marketing Context|Product Marketing Context]]
- [[_COMMUNITY_Prototype Review|Prototype Review]]
- [[_COMMUNITY_POSPal AI-Discovery Benchmark Runbook|POSPal AI-Discovery Benchmark Runbook]]
- [[_COMMUNITY_90-day execution sequence|90-day execution sequence]]
- [[_COMMUNITY_UTM Governance (POSPal)|UTM Governance (POSPal)]]
- [[_COMMUNITY_GA4 Setup Checklist (POSPal)|GA4 Setup Checklist (POSPal)]]
- [[_COMMUNITY_Specialist Guide Template|Specialist Guide Template]]
- [[_COMMUNITY_POSPal Website Redesign Brief|POSPal Website Redesign Brief]]
...
- [[_COMMUNITY_Motion Script|Motion Script]]
- [[_COMMUNITY_Project README|Project README]]
- [[_COMMUNITY_POSPal Product Positioning|POSPal Product Positioning]]
- [[_COMMUNITY_Verified EUR 23.90 Offer|Verified EUR 23.90 Offer]]
- [[_COMMUNITY_Public Asset Rule|Public Asset Rule]]
- [[_COMMUNITY_desktop-support.js Overview|desktop-support.js Overview]]
- [[_COMMUNITY_Direct Subscription Model|Direct Subscription Model]]
- [[_COMMUNITY_Discovery To First Shift Journey|Discovery To First Shift Journey]]
- [[_COMMUNITY_Redesign Capture Archive Cleanup|Redesign Capture Archive Cleanup]]
- [[_COMMUNITY_Internal Link Authority Imbalance|Internal Link Authority Imbalance]]
- [[_COMMUNITY_Legacy Redirect Failure|Legacy Redirect Failure]]
- [[_COMMUNITY_Post-Redesign Measurement Baseline|Post-Redesign Measurement Baseline]]
- [[_COMMUNITY_90-Day SEO Roadmap|90-Day SEO Roadmap]]
- [[_COMMUNITY_PDA Definition and Process Intent|PDA Definition and Process Intent]]
- [[_COMMUNITY_SEO Expansion Gate|SEO Expansion Gate]]
- [[_COMMUNITY_Download Page Handoff|Download Page Handoff]]
- [[_COMMUNITY_GA4 Key Events|GA4 Key Events]]
- [[_COMMUNITY_Generated Artifact Ignore Rules|Generated Artifact Ignore Rules]]
- [[_COMMUNITY_Guide Measurement Events|Guide Measurement Events]]
- [[_COMMUNITY_Homepage Order Route Direction|Homepage Order Route Direction]]
- [[_COMMUNITY_Locked Conversion Core|Locked Conversion Core]]
- [[_COMMUNITY_pospal-artifacts Download Host|pospal-artifacts Download Host]]
- [[_COMMUNITY_POSPal Product|POSPal Product]]
- [[_COMMUNITY_Redesign IA And Onboarding|Redesign IA And Onboarding]]
- [[_COMMUNITY_Search Console Intent Map|Search Console Intent Map]]
- [[_COMMUNITY_SEO Expansion Gate|SEO Expansion Gate]]
- [[_COMMUNITY_decision-pages.js Overview|decision-pages.js Overview]]
- [[_COMMUNITY_Technical SEO Baseline|Technical SEO Baseline]]
...
- `Same-Device Pending Queue` --semantically_similar_to--> `Same-Device Reconnect Boundary`  [INFERRED] [semantically similar]
  systima-paraggeliolipsias.html → asyrmati-paraggeliolipsia.html
...
- **RB-2026-01 Repository-Backed Release System** — docs_seo_pospal_repository_backed_website_proposal_release_1_content_cluster, systima_paraggeliolipsias_ordering_system_hub_page, asyrmati_paraggeliolipsia_wireless_ordering_page, static_css_seo_acquisition_release_1_visual_system, docs_seo_pospal_repository_backed_release_audit_2026_08_05_release_1_verification, docs_seo_pospal_seo_proof_measurement_protocol_rb_2026_01_batch_register [INFERRED 0.95]
- **Evidence-Governed SEO Publication** — docs_seo_pospal_product_fact_checklist_product_fact_register, docs_seo_pospal_generic_hub_improvement_spec_evidence_index_contract, docs_seo_pospal_independent_verification_fact_pack_independent_reproduction_method, docs_seo_pospal_seo_claim_map_claim_to_query_map [INFERRED 0.95]
- **Fact, Proof, and Publication Governance** — docs_seo_pospal_product_fact_checklist_document, docs_seo_pospal_proof_system_document, docs_seo_post_redesign_evaluation_2026_08_02_evidence_led_roadmap [INFERRED 0.85]
...
Cohesion: 0.07
Nodes (29): `B01`, `B02`, `B03`, Broad category, `C01`, `C02`, `C03`, Commercial constraints (+21 more)

### Community 8 - "Academy Progress"
Cohesion: 0.08
Nodes (25): 1. Ξεκίνα εδώ, 2. Κατάλογος και προϊόντα, 3. QR μενού, 4. Παραγγελιοληψία στη βάρδια, 5. Εξοπλισμός και σύνδεση, 6. Λογαριασμός και υποστήριξη, Academy Modules, Copy Direction (+17 more)

### Community 9 - "Test Dependencies"
Cohesion: 0.08
Nodes (24): 1. `/`, 10. `/paraggelio-lipsia-gia-beach-bar.html`, 11. `/asyrmati-paraggeliolipsia.html`, 2. `/download/`, 3. `/guides/`, 4. `/pda-ti-einai.html`, 5. `/pda-pos-leitourgei.html`, 6. `/pda-gia-servitoro/` (+16 more)
...
Cohesion: 0.09
Nodes (22): 1. PDA in hospitality, 2. PDA for waiter, 3. What is a PDA, 4. How PDA works, 5. PDA for cafes, 6. Pricing / system pricing, 7. Wireless ordering, 8. Beach bar ordering (+14 more)

### Community 12 - "Academy Navigation"
Cohesion: 0.19
Nodes (21): bindReset(), bindStepInteractions(), buildBasePayload(), getLevelBuckets(), getNextStep(), getSteps(), init(), levelComplete() (+13 more)

### Community 13 - "Agent Instructions"
Cohesion: 0.10
Nodes (20): 1. Crawlability, 2. Indexability, 3. Performance, 4. Mobile, 5. Security And HTTPS, 6. URL Structure, 7. Structured Data, 8. International SEO (+12 more)

### Community 14 - "Public Asset Hygiene"
Cohesion: 0.10
Nodes (21): Citation fields, Coding rules, Completion rule, Default mode, Evidence capture, `fit_accuracy`, Fixed environment, Forced Search (+13 more)
...
### Community 20 - "Product Glossary"
Cohesion: 0.12
Nodes (15): Academy Technical SEO Audit And URL Migration Plan, Canonical Rules, Crawlability, Evidence, Handoff Summary, Indexability, Launch Checklist, Legacy Redirect Handling (+7 more)

### Community 21 - "POSPal Post-Redesign SEO Evaluation"
Cohesion: 0.13
...
Cohesion: 0.17
Nodes (11): Approved Values, Examples, Naming Rules, Optional Fields, QA Before Launch, `utm_campaign`, `utm_content`, UTM Governance (POSPal) (+3 more)

### Community 29 - "POSPal SEO Opportunities"
Cohesion: 0.29
...
Cohesion: 0.20
Nodes (9): Custom Dimensions (Event Scope), Custom Insights, GA4 Setup Checklist (POSPal), Key Events, Post-Deploy QA, Property, Referrals, Saved Explorations (+1 more)

### Community 31 - "POSPal Technical SEO Baseline"
Cohesion: 0.20
Nodes (9): Academy Hub structure, Content block limits (lesson page), Core principles, Language policy, Lesson Player structure, Progress behavior, Required page types, Specialist Guide Template (Video-first Academy) (+1 more)
...
### Community 33 - "Execution order"
Cohesion: 0.33
Nodes (9): Beach Bar Order-taking Page, Cafe PDA Page, Download-first Funnel, Greek Hospitality Audience, PDA Definition Page, PDA Education Cluster, PDA How-it-works Page, Waiter PDA Page (+1 more)

### Community 34 - "POSPal AI-Discovery Scorecard"
Cohesion: 0.22
Nodes (8): Accessibility & Inclusion, Anti-references, Brand Personality, Design Principles, Product, Product Purpose, Register, Users

### Community 35 - "POSPal Entity Foundation"
Cohesion: 0.43
Nodes (5): clearRouteTimers(), finishRoute(), handleMotionPreferenceChange(), runRoute(), setStage()

### Community 36 - "Academy Technical SEO Migration"
Cohesion: 0.33
...
Cohesion: 0.40
Nodes (5): Mobile Viewport Density Fix, Monthly Price 23.90 EUR, Not Fiscal POS Boundary, Pricing Page, Homepage V3 Prototype

### Community 43 - "GA4 Setup Checklist (POSPal)"
Cohesion: 0.40
Nodes (4): Custom Domain Setup, Linking to Downloads, POSPal Website (GitHub Pages), Updating the Site

### Community 44 - "Specialist Guide Template"
Cohesion: 0.50
Nodes (4): Desktop Menu Item Grid, Desktop Order Ticket Panel, Kitchen/order Workflow, POSPal Desktop Order Screenshot

### Community 45 - "POSPal Website Redesign Brief"
Cohesion: 0.50
Nodes (4): Locked Conversion Core, Windows Installer Handoff, Guided Onboarding Hub, Homepage Conversion Surface
