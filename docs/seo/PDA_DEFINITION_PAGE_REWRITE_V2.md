...
Στην εστίαση, PDA λέμε τη συσκευή που κρατά ο σερβιτόρος για να περνά παραγγελίες.
...
Δεν θέλω να χρειάζεσαι άλλο ένα μηχάνημα κάθε φορά που μπαίνει ακόμη ένας σερβιτόρος στη βάρδια. Το POSPal τρέχει στον υπολογιστή Windows και το προσωπικό ανοίγει την παραγγελιοληψία από κινητό ή tablet στο τοπικό δίκτυο του καταστήματος.

Δεν χρειάζεται ξεχωριστή εφαρμογή στο κινητό. Δεν υπάρχει και έξτρα χρέωση ανά PDA.
